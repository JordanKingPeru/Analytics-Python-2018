...
"""
ruta="D:/Cursos/Big Data & Analytics/Analytics-Python-2018/SegmentoPaisesBajos_PB"  
#Segmento PB
#Age outlier
#CreditScore outlier
...
ds=ds1_PB
np.percentile(ds['NumOfProducts'],q=98) # P95 :60


ds.loc[ds["Age"]>=58,"Age"]=58
ds.loc[ds["CreditScore"]<=452,"CreditScore"]=452
ds.loc[ds["NumOfProducts"]>=3,"NumOfProducts"]=3

plt.boxplot(ds["Age"])
plt.boxplot(ds["CreditScore"])
plt.boxplot(ds["NumOfProducts"])
