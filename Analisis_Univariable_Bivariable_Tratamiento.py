...
#"Importando la data
df=pd.read_csv("D:/Cursos/Big Data & Analytics/Analytics-Python-2018/DataSet/Churn_Modelling_Sample.txt", delimiter="\t")
df.head()

ruta_univariado="D:/Cursos/Big Data & Analytics/Analytics-Python-2018/Graficos_univariado"
ruta_bivariado="D:/Cursos/Big Data & Analytics/Analytics-Python-2018/Graficos_bivariado"
ruta_resumen="D:/Cursos/Big Data & Analytics/Analytics-Python-2018/resumen"


"""
TRATAMIENTO DE DATOS
"""
ruta="D:/Cursos/Big Data & Analytics/Analytics-Python-2018/"  
...
ds.loc[ds["Age"]>=58,"Age"]=58
ds.loc[ds["Balance"]>=186849.0145000001,"Balance"]=186849.0145000001
ds.loc[ds["Balance"]<=0,"Balance"]=0
ds.loc[ds["CreditScore"]<=452,"CreditScore"]=452
...
fa=df["NumOfProducts"].value_counts() 
plt.bar(fa.index,fa)

ds1=df

ds1.to_csv(ruta + "/ds1.csv",index=False)
